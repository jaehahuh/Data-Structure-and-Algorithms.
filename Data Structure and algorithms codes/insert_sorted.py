def insert_sorted(srt_lnk_lst, elem):
    curr_node = srt_lnk_lst.first_node()
    while curr_node is not srt_lnk_lst.trailer and curr_node.data < elem:
    ...
    #srt_lnk_lst.add_before(curr_node, elem)  cant use add_before
